...
| Component | Points |
|---|---|
| Proposal quality (hook, risk, stretch goals, README in repo) | 10 |
| Proof of concept code (compiles, demonstrates hardest challenge) | 20 |
| GitHub hygiene (repo created, code pushed, sensible commit history) | 5 |
| Discussion post + 2 peer comments on classmates' proposals | 5 |
**Goal**: Pick a project and prove the core idea works. (Note: this isn't an MVP yet -- a proof of concept is enough.)
...
- [ ] Write a 1-page proposal covering:
  ...
  - **Why** it is interesting to you (or to the intended user)
  - **Main technical challenge** you expect to face
...
- [ ] Add build instructions (CMake or `g++` one-liner) to the README

### Before Submission
- [ ] Push all code to your GitHub repository
- [ ] Post a short screenshot or terminal transcript to the Canvas Project Discussion board
- [ ] Comment on at least **2** classmates' proposals/PoCs (short, substantive feedback)
- [ ] Submit the GitHub repo URL and a link to your discussion post in Canvas

## What Success Looks Like

- You have proven the hardest technical challenge is solvable
- Your code compiles and runs (even if ugly)
- Your proposal is clear and documented in the repo's README
- You have engaged with the class community via the discussion board
- You are ready to build the MVP in Phase 2
...
---
*Remember: Phase 1 is about feasibility, not perfection. Get the hard part working first.*
