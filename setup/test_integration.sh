...
# Move to the repository root (this script lives in setup/).
cd "$(dirname "$0")/.." || exit 1
...
echo "------------------------------------"
check_dir "assignment-templates"
check_dir "assignment-templates/HW_01"
check_file "assignment-templates/HW_01/CMakeLists.txt"
check_file "assignment-templates/HW_01/src/main.cpp"
check_dir "assignment-templates/chapter-02"
...
if docker info &> /dev/null; then
    ...
    if docker-compose build --quiet cpp-dev &> /dev/null; then
